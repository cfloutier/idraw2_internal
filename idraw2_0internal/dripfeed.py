...
def feed(ad_ref, move_list):
    """
    Feed individual motion actions to the iDraw during a plot or preview.
    ...
    Inputs: iDraw reference object, list of movement commands
    """
...
def feed_sm(ad_ref, move, drip_logger):
    """
    Manage the process of sending a single "SM" move command to the iDraw,
    ...
    if ad_ref.options.preview:
        ...
        drawcore_motion.doXYMove(ad_ref.plot_status.port, move_steps2, move_steps1,\
            move_time, False)
